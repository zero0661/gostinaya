const rooms = {
  ...
  news: {
    ...
    lead: 'Новые материалы, аудиоверсии, объявления и изменения проекта.',
    text: 'Здесь появляются новости проекта, которые можно обсудить вместе с участниками Гостиной.'
  },
  discussions: {
